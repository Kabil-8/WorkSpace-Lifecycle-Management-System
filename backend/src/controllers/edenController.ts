...
export class EdenController {
  ...
  static async chat(req: any, res: Response) {
    ...
    try {
      ...
      return res.json({
        ...
        fusion: (resData as any).fusion || null,
        conversationId: uId,
        metrics: { latencyMs },
      })
    } catch (err: any) {
  ...
  static async getProactiveIntervention(req: any, res: Response) {
    try {
      const uId = req.user._id.toString()
   ...
   */
  static async recordTelemetry(req: any, res: Response) {
    try {
   ...
   */
  static async completeIntervention(req: any, res: Response) {
    try {
      const uId = req.user._id.toString()
