...
export class CompilerEngine {
  private static tempDir = path.join(os.tmpdir(), 'edusphere-compiler')
  ...
  public static async execute(
    ...
    onDataChunk?: (chunk: { type: 'stdout' | 'stderr'; text: string }) => void
  ...
  private static cleanFiles(file1?: string, file2?: string) {
    try {
