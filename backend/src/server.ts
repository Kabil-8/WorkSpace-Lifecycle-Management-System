...
import {
  assignmentRouter, jobRouter, eventRouter, forumRouter,
  gamificationRouter, adminRouter, notificationRouter, searchRouter,
  timetableRouter, placementRouter, roleDashboardRouter,
  kanbanRouter, analyticsRouter, hallOfFameRouter, interviewRouter
} from './routes/v1/domainRoutes.js'
import {
  parentRouter, hodRouter, recruiterRouter, financeRouter, observabilityRouter,
} from './routes/v1/enterpriseRoutes.js'
