...
export interface IEdenConversation extends Document {
  ...
  messages: {
    ...
    text: string
    timestamp: Date
    multimodalType?: 'text' | 'voice' | 'pdf' | 'image' | 'code'
...
export interface IEdenDigitalTwin extends Document {
  userId: string
  xp: number
...
const EdenDigitalTwinSchema = new Schema<IEdenDigitalTwin>({
...
export const EdenConversation = mongoose.models.EdenConversation || mongoose.model<IEdenConversation>('EdenConversation', EdenConversationSchema)
export const EdenDigitalTwin = mongoose.models.EdenDigitalTwin || mongoose.model<IEdenDigitalTwin>('EdenDigitalTwin', EdenDigitalTwinSchema)
