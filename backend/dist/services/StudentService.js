...
export class StudentService {
     ...
     */
    static async getAttendanceOnly(userId) {
        try {
     ...
     */
    static async getAssignmentsOnly(userId) {
        try {
    ...
    static async getContextData(userId) {
        try {
            ...
            const [totalClasses, attended, assignments, courses, upcomingExams, notifications, gamification,] = await Promise.all([
