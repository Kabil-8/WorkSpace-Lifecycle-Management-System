...
export class MLController {
     ...
     */
    static async calculateATSScore(req, res) {
        try {
        ...
        try {
            ...
            res.status(500).json({ success: false, message: 'Failed to compute ATS Score', error: err.message });
        }
    }
    /**
     * POST /api/ml/interview/questions
     */
    static getInterviewQuestions(req, res) {
        try {
            ...
            res.status(500).json({ success: false, message: 'Failed to generate interview questions', error: err.message });
        }
    }
    /**
     ...
     */
    static async predictPlacement(req, res) {
        try {
     ...
     */
    static async get5SubDigitalTwin(req, res) {
        try {
