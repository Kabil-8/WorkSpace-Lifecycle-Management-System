 ...
 */
export async function getTodayQueue(req, res) {
    try {
...
export async function submitReview(req, res) {
    try {
        ...
        if (!item) {
            ...
            const topicName = req.body.topicName || String(topicId).replace(/[-_]/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase());
            item = new RecallItem({
                userId,
                topicId,
                topicName,
...
function computeReviewStreak(items) {
