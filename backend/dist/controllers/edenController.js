...
export class EdenController {
    ...
    static async uploadDocument(req, res) {
        try {
            ...
            const doc = await RAGEngine.chunkAndEmbedDocument(docTitle, category, user.department || 'All Departments', fileContent, user._id);
    ...
    static async analyzeVision(req, res) {
        try {
            if (!req.file) {
